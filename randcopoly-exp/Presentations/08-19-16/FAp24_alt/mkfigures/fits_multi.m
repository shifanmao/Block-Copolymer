...
% plot parameters
NEXP = [1,3,5,7,9];   % experiment plot range
NREP = [35,36,37,38,39,40];  % number of replicas
...
%  plot(x2,B(1)+B(2)*y2,'.-','MarkerSize',15,'linewidth',1.5,'color',[col 0 1-col])
  plot(x2,exp(B(cnt,1)+B(cnt,2)*log(y2)),'.-','MarkerSize',15,'linewidth',1.5,'color',[col 0 1-col])
...
saveas(gcf,strcat(figdir,'skfit'),'epsc')
