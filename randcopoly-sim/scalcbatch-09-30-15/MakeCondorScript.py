...
testnumv = [1,2,3,4,7,8,9,10,15,16,17,18]
cpnumv =   [1,1,1,2,2,1,1, 1, 2, 1, 1, 2]
...
for i in range(0,len(testnumv)):
    ...
    if not os.access('%s' %foldername,os.F_OK):
        ...
        CONDOR.write("Initialdir = /tower12/home/shifan/polymem-wlc-pt/scalcbatch-09-30-15/%s/mfiles/ \n" %foldername)
